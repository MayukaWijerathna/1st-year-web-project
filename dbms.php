...
<head>
	...
	<script language="javascript" type="text/javascript" src="dbms.js"></script>
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							...
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">| Introduction to DB Systems </div>
							...
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">| Tutorial 1 </div>
							...
							<div id="categorydiv1" onmouseover="sofbutton()"; onmouseout="mouseleaveb4();">
								<div id="categorydiv1a">| ER Modeling</div>
							...
							<div id="categorydiv1" onmouseover="sogbutton()"; onmouseout="mouseleaveb5();">
								<div id="categorydiv1a">| Tutorial 2A - ER Problems</div>
