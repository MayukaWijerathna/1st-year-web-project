...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dbms3.css">
	<script language="javascript" type="text/javascript" src="dbms3.js"></script>
						...
						<div id="bmargindiv2">
                            ...
                            <?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==1){
						            echo '
							<a href="lessons/DBMS/SQL_tutorial.docx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
								<div id="categorydiv1a">| SQL Tutorial and lab </div>
								<div id="categorydiv1b1"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/DBMS/2._File_based_Systems.ppt" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">| File Based Systems Vs. Database Approach </div>
