						...
						<div id="bmargindiv2">
                              <?php 
                                ...
                                if (!$conn2){
                                        ...
                                        $sql6 = "SELECT * FROM events WHERE eventno='1'";
                                ...
                                if(!$row = mysqli_fetch_assoc($result6)){
                                    ...
                                    $_SESSION['eventtime1'] = $row['eventtime'];
                                    $_SESSION['eventvenue1'] = $row['eventvenue'];
                                    $_SESSION['eventdescription1'] = $row['eventdescription'];


                                }
                                   	echo '   
							<a id="btitle1">'.$_SESSION['eventtitle1'].'</a><br><br>
							<div id="bline1"></div>
							<br><br>';
                                         if (isset($_SESSION['username'])){
                                             echo'
							...
							<p id="bcontent1">
                            <b>Time : </b>'.$_SESSION['eventtime1'].'
							</p>
                            
                            <p id="bcontent1">
                            <b>Venue : </b>'.$_SESSION['eventvenue1'].'
							</p>
                            
                            <p id="bcontent1">
                            '.$_SESSION['eventdescription1'].'
							</p>';
