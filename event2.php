						...
						<div id="bmargindiv2">
                              <?php 
                                ...
                                if (!$conn2){
                                        ...
                                        $sql7 = "SELECT * FROM events WHERE eventno='2'";
                                ...
                                if(!$row = mysqli_fetch_assoc($result7)){
                                    ...
                                    $_SESSION['eventtime2'] = $row['eventtime'];
                                    $_SESSION['eventvenue2'] = $row['eventvenue'];
                                    $_SESSION['eventdescription2'] = $row['eventdescription'];


                                }
                                   	echo '   
							<a id="btitle1">'.$_SESSION['eventtitle2'].'</a><br><br>
							<div id="bline1"></div>
							<br><br>';
                                         if (isset($_SESSION['username'])){
                                             echo'
							...
							<p id="bcontent1">
                            <b>Time : </b>'.$_SESSION['eventtime2'].'
							</p>
                            
                            <p id="bcontent1">
                            <b>Venue : </b>'.$_SESSION['eventvenue2'].'
							</p>
                            
                            <p id="bcontent1">
                            '.$_SESSION['eventdescription2'].'
							</p>';
