						...
						<div id="bmargindiv2">
                              <?php 
                                ...
                                if (!$conn2){
                                        ...
                                        $sql9 = "SELECT * FROM events WHERE eventno='4'";
                                ...
                                if(!$row = mysqli_fetch_assoc($result9)){
                                    ...
                                    $_SESSION['eventtime4'] = $row['eventtime'];
                                    $_SESSION['eventvenue4'] = $row['eventvenue'];
                                    $_SESSION['eventdescription4'] = $row['eventdescription'];


                                }
                                   	echo '   
							<a id="btitle1">'.$_SESSION['eventtitle4'].'</a><br><br>
							<div id="bline1"></div>
							<br><br>';
                                         if (isset($_SESSION['username'])){
                                             echo'
							...
							<p id="bcontent1">
                            <b>Time : </b>'.$_SESSION['eventtime4'].'
							</p>
                            
                            <p id="bcontent1">
                            <b>Venue : </b>'.$_SESSION['eventvenue4'].'
							</p>
                            
                            <p id="bcontent1">
                            '.$_SESSION['eventdescription4'].'
							</p>';
