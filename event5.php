						...
						<div id="bmargindiv2">
                              <?php 
                                ...
                                if (!$conn2){
                                        ...
                                        $sql10 = "SELECT * FROM events WHERE eventno='5'";
                                ...
                                if(!$row = mysqli_fetch_assoc($result10)){
                                    ...
                                    $_SESSION['eventtime5'] = $row['eventtime'];
                                    $_SESSION['eventvenue5'] = $row['eventvenue'];
                                    $_SESSION['eventdescription5'] = $row['eventdescription'];


                                }
                                   	echo '   
							<a id="btitle1">'.$_SESSION['eventtitle5'].'</a><br><br>
							<div id="bline1"></div>
							<br><br>';
                                         if (isset($_SESSION['username'])){
                                             echo'
							...
							<p id="bcontent1">
                            <b>Time : </b>'.$_SESSION['eventtime5'].'
							</p>
                            
                            <p id="bcontent1">
                            <b>Venue : </b>'.$_SESSION['eventvenue5'].'
							</p>
                            
                            <p id="bcontent1">
                            '.$_SESSION['eventdescription5'].'
							</p>';
