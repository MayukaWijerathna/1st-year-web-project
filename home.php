		...
		<div id="bodydiv">
				...
				<div id="bodylinediv1"></div>
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">COURSE CATEGORIES</a><br><br>
							<div id="bline1"></div>
							<br><br>
    
							<a href="soc.php" id="txtcate1">
							<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
								<div id="categorydiv1a">| SCHOOL OF COMPUTING</div>
								<div id="categorydiv1b1"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="sob.php" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">| SCHOOL OF BUSINESS</div>
								<div id="categorydiv1b2"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="soe.php" id="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">| SCHOOL OF ENGINEERING</div>
