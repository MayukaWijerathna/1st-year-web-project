...
<head>
	...
	<script language="javascript" type="text/javascript" src="int.js"></script>
						...
						<div id="bmargindiv2">
                            ...
                            <?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==1){
						            echo '
							<a href="lessons/INTRO/Introduction_to_Computer_Science_Module_Discriptor.pdf" target="blank" id="txtcate1">
							...
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Lec1.pdf" target="blank" id="txtcate1">
							...
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Number_Systems_Exercises.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">| Number Systems Exercises </div>
								<div id="categorydiv1b3"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Memory_Devices.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sofbutton()"; onmouseout="mouseleaveb4();">
								<div id="categorydiv1a">|  Lecture 3,4, 5 - Memory Devices</div>
								<div id="categorydiv1b4"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Parts_of_a_Hard_Disk.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sogbutton()"; onmouseout="mouseleaveb5();">
								<div id="categorydiv1a">|   Parts of a Computer Hard Disk</div>
