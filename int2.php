...
<head>
	...
	<script language="javascript" type="text/javascript" src="int2.js"></script>
		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">CS101.3 INTRODUCTION TO COMPUTER SCIENCE</a><br><br>
							<div id="bline1"></div>
							<br><br>
                            <?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==1){
						            echo '
							<a href="lessons/INTRO/Optical_Storage_Media_.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
								<div id="categorydiv1a">| Optical Storage Media - Additional Notes </div>
								<div id="categorydiv1b1"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Data_Representation.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">| Lecture 6 - Representation of Data</div>
								<div id="categorydiv1b2"></div> 
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Tutorial_2.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">| Representation of Data - Exercisess </div>
								<div id="categorydiv1b3"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Ebusiness_and_ECommerce.ppt" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sofbutton()"; onmouseout="mouseleaveb4();">
								<div id="categorydiv1a">|  E Business and E Commerce</div>
								<div id="categorydiv1b4"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/INTRO/Introduction_to_Computer_Science-Session_2.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sogbutton()"; onmouseout="mouseleaveb5();">
								<div id="categorydiv1a">|   Globalization-Ecommerce-Ethics</div>
