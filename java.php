		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">SE101.3 OBJECT ORIENTED PROGRAMMING WITH JAVA</a><br><br>
							<div id="bline1"></div>
							<br><br>
                            <?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==1){
						            echo '
							<a href="lessons/java/BMIS108_Programming_in_Java.pdf" target="blank" id="txtcate1">
							...
							<div id="bspace1"></div>
							<a href="lessons/java/SE101_Lec1_JAVABASICS.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">|  SE16.2_Lecture 01 </div>
								<div id="categorydiv1b2"></div> 
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/java/SE101_Lec2_ObjectsClasses.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">|   Lecture 02- OOP - Classes and Objects </div>
								<div id="categorydiv1b3"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/java/SE101_Lec3_Encap.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sofbutton()"; onmouseout="mouseleaveb4();">
								<div id="categorydiv1a">|  Lec03_OOP_Encapsulation</div>
								<div id="categorydiv1b4"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/java/SE101_Lec4_InheritanceAbstractFinal.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sogbutton()"; onmouseout="mouseleaveb5();">
								<div id="categorydiv1a">| Lec04_OOP_Inheritance_Abstraction</div>
