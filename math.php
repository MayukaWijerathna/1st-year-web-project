		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">CS105.1 MATHEMATICS FOR COMPUTING </a><br><br>
							<div id="bline1"></div>
							<br><br>
                            <?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==1){
						            echo '
							<a href="lessons/Maths/CS105.1_Mathematics_for_Computing_I.pdf" target="blank" id="txtcate1">
							...
							<div id="bspace1"></div>
							<a href="lessons/Maths/MA1-Vectors.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">|  Vectors </div>
								<div id="categorydiv1b2"></div> 
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/Maths/Differentiation.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">|  Notes on Differentiation </div>
								<div id="categorydiv1b3"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/Maths/MA1-Matrices.pptx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sofbutton()"; onmouseout="mouseleaveb4();">
								<div id="categorydiv1a">|  Matrix Algebra</div>
								<div id="categorydiv1b4"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="lessons/Maths/MA1-Solving_linear_equations-Matrix_inversion.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sogbutton()"; onmouseout="mouseleaveb5();">
								<div id="categorydiv1a">|  Solving a System of Linear Equations</div>
