...
<head>
	...
	<script language="javascript" type="text/javascript" src="exam.js"></script>
		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">EXAMINATION TIME TABLES</a><br><br>
							<div id="bline1"></div>
							<br><br>
							<?php  
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==2){
						            echo '
							<a href="files/SpecialExamSchedule_2017.xlsx" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
								<div id="categorydiv1a">| SPECIAL EXAM SCHEDULE 2017</div>
