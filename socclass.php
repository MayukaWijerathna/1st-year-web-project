...
<head>
	...
	<link rel="stylesheet" type="text/css" href="socclass.css">
	<script language="javascript" type="text/javascript" src="socclass.js"></script>
		...
		<div id="bodydiv">
						...
						<div id="bmargindiv2">
							...
							<?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==1){
						            echo '
							<a href="files/16.1_A1.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
								<div id="categorydiv1a">| 16.1 GROUP-A </div>
								<div id="categorydiv1b1"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/16.1_B1.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">| 16.1 GROUP-B </div>
								<div id="categorydiv1b2"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/16.2_A1.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">| 16.2 GROUP-A1</div>
								<div id="categorydiv1b3"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/16.2_A2.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sofbutton()"; onmouseout="mouseleaveb4();">
								<div id="categorydiv1a">| 16.2 GROUP-A2</div>
								<div id="categorydiv1b4"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/16.2_B1.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sogbutton()"; onmouseout="mouseleaveb5();">
								<div id="categorydiv1a">| 16.2 GROUP-B1</div>
				...
				<div id="bodydiv3">
					...
					<div id="bodydiv332" onmouseover="nextbutton()"; onmouseout="mouseleav();">
						<a href="socclass2.php" id="textnavb">></a>
					</div>
				</div>
		</div>
