...
<head>
	...
	<link rel="stylesheet" type="text/css" href="socclass2.css">
	<script language="javascript" type="text/javascript" src="socclass2.js"></script>
		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">CLASS TIME TABLES</a><br><br>
							<div id="bline1"></div>
							<br><br>
							<?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==1){
						            echo '
							<a href="files/16.2_B2.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
								<div id="categorydiv1a">| 16.2 GROUP-B2</div>
								<div id="categorydiv1b1"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/17.1_A1.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">| 17.1 GROUP-A1 </div>
								<div id="categorydiv1b2"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/17.1_A2.pdf" target="blank" d="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">| 17.1 GROUP-A2</div>
								<div id="categorydiv1b3"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/17.1_B1.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sofbutton()"; onmouseout="mouseleaveb4();">
								<div id="categorydiv1a">| 17.1 GROUP-B1</div>
								<div id="categorydiv1b4"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="files/17.1_B2.pdf" target="blank" id="txtcate1">
							<div id="categorydiv1" onmouseover="sogbutton()"; onmouseout="mouseleaveb5();">
								<div id="categorydiv1a">| 17.1 GROUP-B2</div>
				...
				<div id="bodydiv3">
					...
					<div id="bodydiv331" onmouseover="backbutton()"; onmouseout="mouseleav();">
						<a href="socclass.php" id="textnavb"><</a>
					</div>
