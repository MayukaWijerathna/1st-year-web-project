...
<head>
	...
	<link rel="stylesheet" type="text/css" href="soccourse.css">
	<script language="javascript" type="text/javascript" src="soccourse.js"></script>
		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">COURSE YEAR </a><br><br>
							<div id="bline1"></div>
							<br><br>
							<?php 									 
						          if (isset($_SESSION['username'])){
