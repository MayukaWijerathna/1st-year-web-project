...
<head>
	...
	<script language="javascript" type="text/javascript" src="courses.js"></script>
		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">SCHOOL OF BUSINESS</a><br><br>
							<div id="bline1"></div>
							<br><br>
							<?php 									 
						          if (isset($_SESSION['username'])){
						          	...
						          	if ($a==3){						          		
						            echo '
											<a href="soecourse.php" id="txtcate1">
											<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
												<div id="categorydiv1a">| COURSE CATEGORIES</div>
												<div id="categorydiv1b1"></div>
											</div>
											</a>
											<div id="bspace1"></div>
											<a href="soeclass.php" id="txtcate1">
											<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb2();">
												<div id="categorydiv1a">| CLASS TIME TABLES</div>
												<div id="categorydiv1b2"></div>
											</div>
											</a>
											<div id="bspace1"></div>
											<a href="soeexam.php" id="txtcate1">
											<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
												<div id="categorydiv1a">| EXAMINATION TIME TABLES</div>
