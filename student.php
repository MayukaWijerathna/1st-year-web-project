...
<head>
	...
	<script language="javascript" type="text/javascript" src="student.js"></script>
		...
		<div id="bodydiv">
				...
				<div id="bodylinediv1"></div>
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">STUDENT AREA</a><br><br>
							<div id="bline1"></div>
							<br><br>
    
							<a href="news.php" id="txtcate1">
							<div id="categorydiv1" onmouseover="socbutton()"; onmouseout="mouseleaveb1();">
								<div id="categorydiv1a">| IMPORTANT NEWS</div>
								<div id="categorydiv1b1"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="events.php" id="txtcate1">
							<div id="categorydiv1" onmouseover="sobbutton()"; onmouseout="mouseleaveb2();">
								<div id="categorydiv1a">| ADDITIONAL EVENTS</div>
								<div id="categorydiv1b2"></div>
							</div>
							</a>
							<div id="bspace1"></div>
							<a href="assignment.php" id="txtcate1">
							<div id="categorydiv1" onmouseover="soebutton()"; onmouseout="mouseleaveb3();">
								<div id="categorydiv1a">| ASSIGNMENT SUBMIT</div>
