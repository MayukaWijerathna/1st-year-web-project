		...
		<div id="bodydiv">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							<a id="btitle1">SUPPORT</a><br><br>
							<div id="bline1"></div>
							<br><br>
														
							<form id="supform" action="supdata.php" method="post" >
							<table id="supform1">
							<tr>
							<td><a id="captxt1">Name:</a></td>
							<td><input id="inp1" type="text" name="name" maxlength="20"></td>
							</tr>
							<tr>
							<td><a id="captxt1">Student Id:</a></td>
							<td><input id="inp1" type="text" name="sid" maxlength="20"></td>
							</tr>
							<tr>
							<td><a id="captxt1">Problem Type:</a></td>
							<td><input id="inp1" type="text" name="type" maxlength="30"></td>
							</tr>
							<tr>
							<td><a id="captxt1">Problem:</a></td>
							<td><input id="inp1" type="text" name="problem" maxlength="200"></td>
							</tr>
							<tr>
							<td>
							<br>
							<input id="button1" type="submit" value="Submit Ticket">
							</td>
							</tr>
							</table>
							</form>
							...
							<div id="bline1"></div>
							<br>
							<form id="suptfrm" action="suptick.php" method="post" >
							<table id="supform1">
							<tr>
							<td><input id="inp1" type="text" name="sid" maxlength="20" placeholder="Student ID"></td>
							<td><input id="button1" type="submit" value="Show Ticket"></td>
							</tr>
							</table>							 
						</div>
					</div>
