				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							...
							<div id="bline1"></div>
							<br><br>														
							<input id="button1" type="button" onclick="window.location.href='support.php'" value="Go Back"></td>
							<br><br><a id="navtxtmsg">

							<?php
								$a= $_POST['sid'];								
								$file = fopen("admin/support/$a.txt", "r") or die("<br>YOUR SUPPORT TICKET IS NOT AVILABLE");
								echo fread($file,filesize("admin/support/$a.txt"));
								fclose($file);
								?>										
							</a>						 
						</div>
