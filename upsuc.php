...
<head>
	...
	<link rel="stylesheet" type="text/css" href="regsuc.css">
				...
				<div id="bodydiv2">
					...
					<div id="bodydiva">
						...
						<div id="bmargindiv2">
							...
							<br><br><br>
							<a id="conttxt">
								YOU HAVE SUCCESSFULLY UPDATED DATABASE!<br><br>PLEASE LOGIN AGAIN TO SEE CHANGES.
							</a>
							<br><br>
							<input type="button" onclick="window.location.href='logout.php'" id="button1" value="CHECK">
							</center>
						</div>
					</div>
				</div>
